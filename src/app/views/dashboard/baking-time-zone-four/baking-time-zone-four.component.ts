...
@Component({
  ...
  templateUrl: './baking-time-zone-four.component.html',
  styleUrls: ['./baking-time-zone-four.component.scss']
})
export class BakingTimeZoneFourComponent implements OnInit {
  radioModel = '5s';
